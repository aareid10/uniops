...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"assets/styles/app.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"assets/scripts/views/bigObjectEq.jsx":[function(require,module,exports) {
"use strict";
...
var bigObjectSymbols = /*#__PURE__*/function (_Component) {
  _inherits(bigObjectSymbols, _Component);

  var _super = _createSuper(bigObjectSymbols);

  function bigObjectSymbols() {
    _classCallCheck(this, bigObjectSymbols);

    return _super.apply(this, arguments);
  }

  _createClass(bigObjectSymbols, [{
    key: "render",
    value: function render() {
      return (0, _preact.h)("mark", null, (0, _preact.h)("i", {
        ...
        class: "em em-triangular_flag_on_post"
      }), " =", (0, _preact.h)("i", {
        class: "em em-relieved"
      }));
    }
  }]);

  return bigObjectSymbols;
}(_preact.Component);

exports.default = bigObjectSymbols;
},{"preact":"../node_modules/preact/dist/preact.mjs"}],"assets/scripts/views/bigArrayEq.jsx":[function(require,module,exports) {
"use strict";
  ...
  _createClass(bigObjectSymbols, [{
    ...
    value: function render() {
      return (0, _preact.h)("mark", null, (0, _preact.h)("i", {
        ...
        class: "em em-bookmark"
      }), (0, _preact.h)("i", {
        class: "em em-admission_tickets"
      }), (0, _preact.h)("i", {
        class: "em em-triangular_flag_on_post"
      }), " =", (0, _preact.h)("i", {
        class: "em em-relieved"
...
exports.default = bigObjectSymbols;
},{"preact":"../node_modules/preact/dist/preact.mjs"}],"assets/scripts/views/bigCanvasEq.jsx":[function(require,module,exports) {
"use strict";
...
exports.default = bigObjectSymbols;
},{"preact":"../node_modules/preact/dist/preact.mjs"}],"assets/scripts/views/bigFileEq.jsx":[function(require,module,exports) {
"use strict";
...
var bigFileEq = /*#__PURE__*/function (_Component) {
  _inherits(bigFileEq, _Component);

  var _super = _createSuper(bigFileEq);

  function bigFileEq() {
    _classCallCheck(this, bigFileEq);

    return _super.apply(this, arguments);
  }

  _createClass(bigFileEq, [{
    key: "render",
    value: function render() {
      return (0, _preact.h)("mark", null, (0, _preact.h)("i", {
        class: "em em-face_with_symbols_on_mouth"
...
exports.default = bigFileEq;
},{"preact":"../node_modules/preact/dist/preact.mjs"}],"../node_modules/unistore/preact.js":[function(require,module,exports) {
...
},{"preact":"../node_modules/preact/dist/preact.mjs"}],"../node_modules/unistore/dist/unistore.es.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/unistore/devtools.js":[function(require,module,exports) {
...
},{}],"assets/scripts/data/store.js":[function(require,module,exports) {
"use strict";
...
module.exports = (0, _devtools.default)((0, _unistore.default)(initialState));
},{"unistore":"../node_modules/unistore/dist/unistore.es.js","unistore/devtools":"../node_modules/unistore/devtools.js"}],"../index.js":[function(require,module,exports) {
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

module.exports = function (log, debug) {
  /* CONFIG */
  log ? void 0 : console.log = function () {};
  ...
  var uniops = {
    buildOperator: function buildOperator(initMsg, worker_fn) {
      log ? void 0 : initMsg = '';
      var blob = new Blob(["\t".concat(initMsg, " \n\tonmessage = ").concat(worker_fn.toString())], {
        type: "text/javascript"
      });
      return new Worker(window.URL.createObjectURL(blob));
    },
    bindOperator: {
      replace: function replace(op, store, update) {
        binding = '[R]';

        if (op.onmessage === null) {
          console.log("|UniOps| (%) ".concat(binding, " New STATUS from Worker: Event hook registered."));
          ...
          op.onmessage = function (msg) {
            ...
            switch (_typeof(work)) {
              case 'string':
                if (work.match(/(%)/)) {
                  console.log("|UniOps| (%) ".concat(binding, " ").concat(assignment, " New MESAGE from Worker..."));
                  debug ? console.log(msg.data) : void 0;
                } else if (work.match(/data:image/)) {
                  console.log("|UniOps| (%) ".concat(binding, " ").concat(assignment, " New WORK from Worker..."));
                  debug ? console.log("|UniOps| (%) ".concat(binding, " ").concat(assignment, " View WORK:\n"), work) : void 0;
                  store.setState(_defineProperty({}, update, work));
                  return response;
                } else {
      ...
      modify: function modify(op, store, update) {
        binding = '[M]';
    ...
    assignOperator: {
      ...
      network: {
        xhr: {
          get: function get(parentMSG) {
            var xhr = new XMLHttpRequest();
            xhr.open('GET', parentMSG.data, true);

            xhr.onload = function (e) {
              postMessage(['[X.G]', xhr.response]);
            };
        ...
        gql: {
          query: function query(parentMSG) {
            var xhr = new XMLHttpRequest();
            xhr.open('POST', parentMSG.data[0], true);

            xhr.onload = function (e) {
              postMessage(['[G.Q]', JSON.parse(xhr.response)]);
            };
        ...
        file: {
          upload: function upload(parentMSG) {}
        }
      },

      /* * * Array Operators * * */
      array: {
        map: function map(parentMSG) {
          var interpreter = function interpreter(code) {
            return Function('"use strict";return (' + code + ')')();
          };

          var arrayInst = parentMSG.data[0];
          var arrayMapFx = interpreter(parentMSG.data[1]);
          var arrayUpdated = arrayInst.map(function (x) {
            return arrayMapFx(x);
          });
          postMessage(['[A.M]', arrayUpdated]);
        },
        filter: function filter(parentMSG) {
          var interpreter = function interpreter(code) {
            return Function('"use strict";return (' + code + ')')();
          };

          var arrayInst = parentMSG.data[0];
          var arrayFilterFx = interpreter(parentMSG.data[1]);
          var arrayUpdated = arrayInst.filter(function (x) {
            return arrayFilterFx(x);
          });
          postMessage(['[A.F]', arrayUpdated]);
        },
        reduce: function reduce(parentMSG) {
          var interpreter = function interpreter(code) {
            return Function('"use strict";return (' + code + ')')();
          };

          var arrayInst = parentMSG.data[0];
          var arrayReduceFX = interpreter(parentMSG.data[1]);
          var arrayUpdated = arrayInst.reduce(arrayReduceFX);
          postMessage(['[A.R]', [arrayUpdated]]);
        },
        underscore: {
          union: function union(parentMSG) {
            self.importScripts('https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.9.1/underscore-min.js');

            var arrayUpdated = _.union(parentMSG.data[0], parentMSG.data[1]);

            postMessage(['[U.UNION]', arrayUpdated]);
          },
          intrsc: function intrsc(parentMSG) {
            self.importScripts('https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.9.1/underscore-min.js');

            var arrayUpdated = _.intersection(parentMSG.data[0], parentMSG.data[1]);

            postMessage(['[U.INTER]', arrayUpdated]);
          },
          diff: function diff(parentMSG) {
            self.importScripts('https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.9.1/underscore-min.js');

            var arrayUpdated = _.difference(parentMSG.data[0], parentMSG.data[1]);

            postMessage(['[U.DIFF]', arrayUpdated]);
          },
          uniq: function uniq(parentMSG) {
            self.importScripts('https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.9.1/underscore-min.js');

            var arrayUpdated = _.uniq(parentMSG.data);

            postMessage(['[U.UNIQ]', arrayUpdated]);
          },
          aryobj: function aryobj(parentMSG) {
            self.importScripts('https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.9.1/underscore-min.js');

            var arrayUpdated = _.object(parentMSG.data[0], parentMSG.data[1]);
      ...
      /* * * Canvas Operators * * */
      canvas: {
        pixels: function pixels(parentMSG) {
          var interpreter = function interpreter(code) {
            return Function('"use strict";return (' + code + ')')();
          };

          var imgFx = interpreter(parentMSG.data[0]);
          var imgData = parentMSG.data[1];
          ...
          ;
          var updatedImgData = new ImageData(pixels, imgWidth, imgHeight);
      ...
      file: {
        ...
        toblob: function toblob(parentMSG) {
          var BASE64_MARKER = ";base64,";
          var dataURL = parentMSG.data;
          var dataURLBlob;
...
},{}],"assets/scripts/components/BigArray.jsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.BigArray = exports.actions = void 0;
...
var uniops = require('../../../../index')(true, true);
/* Methods */


var genBigArray = function genBigArray(length, max) {
...
var operators = {
  arrayOpMap: function arrayOpMap() {
    var worker_init_msg = "console.log('|UniOps| (%) arrayOpMap Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.array.map);
    return worker;
  },
  arrayOpFilter: function arrayOpFilter() {
    var worker_init_msg = "console.log('|UniOps| (%) arrayOpFilter Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.array.filter);
    return worker;
  },
  arrayOpReduce: function arrayOpReduce() {
    var worker_init_msg = "console.log('|UniOps| (%) arrayOpReduce Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.array.reduce);
    return worker;
  },
  arrayOpUnion: function arrayOpUnion() {
    var worker_init_msg = "console.log('|UniOps| (%) arrayOpUnion Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.array.underscore.union);
    return worker;
  },
  arrayOpUnique: function arrayOpUnique() {
    var worker_init_msg = "console.log('|UniOps| (%) arrayOpUnique Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.array.underscore.uniq);
    return worker;
  },
  arrayOpIntersection: function arrayOpIntersection() {
    var worker_init_msg = "console.log('|UniOps| (%) arrayOpIntersection Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.array.underscore.intrsc);
    return worker;
  },
  arrayOpDifference: function arrayOpDifference() {
    var worker_init_msg = "console.log('|UniOps| (%) arrayOpDifference Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.array.underscore.diff);
    return worker;
  },
  arrayOpObject: function arrayOpObject() {
    var worker_init_msg = "console.log('|UniOps| (%) arrayOpObject Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.array.underscore.aryobj);
    return worker;
  }
};
/* * * * * * * * * * * * * * * * * * * * *
...
var arrayOpMap = operators.arrayOpMap();
var arrayOpFilter = operators.arrayOpFilter();
var arrayOpReduce = operators.arrayOpReduce();
var arrayOpUnion = operators.arrayOpUnion();
var arrayOpUnique = operators.arrayOpUnique();
var arrayOpIntersection = operators.arrayOpIntersection();
var arrayOpDifference = operators.arrayOpDifference();
var arrayOpObject = operators.arrayOpObject();
/* * * * * * * * * * * * * * * * * * * * *
* Operator Variables
* * * * * * * * * * * * * * * * * * * * */

var mapOperation = function mapOperation(a) {
  return a * 25;
};

var filterOperation = function filterOperation(a) {
  return a > 50;
};

var reduceOperation = function reduceOperation(a, c) {
  return a + c;
};

var dispRegex = /\B(?=(\d{3})+(?!\d))/g;
var arrayOrder = 10000;
var arrayMaxValA = 100;
var arrayMaxValB = 200;
/* * * * * * * * * * * * * * * * * * * * *
* Operator Actions
* * * * * * * * * * * * * * * * * * * * */

var actions = function actions(store) {
  var loadArray = function loadArray(_ref) {
    var bigArray = _ref.bigArray;
    store.setState({
      bigArray: genBigArray(arrayOrder, arrayMaxValA)
    });
  };

  var updateArrayMap = function updateArrayMap(_ref2) {
    var bigArray = _ref2.bigArray;
    var workerPkg = [bigArray, mapOperation.toString()];
    uniops.bindOperator.replace(arrayOpMap, store, 'bigArray');
    arrayOpMap.postMessage(workerPkg);
  };

  var updateArrayFilter = function updateArrayFilter(_ref3) {
    var bigArray = _ref3.bigArray;
    var workerPkg = [bigArray, filterOperation.toString()];
    uniops.bindOperator.replace(arrayOpFilter, store, 'bigArray');
    arrayOpFilter.postMessage(workerPkg);
  };

  var updateArrayReduce = function updateArrayReduce(_ref4) {
    var bigArray = _ref4.bigArray;
    var workerPkg = [bigArray, reduceOperation.toString()];
    uniops.bindOperator.replace(arrayOpReduce, store, 'bigArray');
    arrayOpReduce.postMessage(workerPkg);
  };

  var updateArrayUnion = function updateArrayUnion(_ref5) {
    var bigArray = _ref5.bigArray;
    var workerPkg = [bigArray, genBigArray(arrayOrder, arrayMaxValB)];
    uniops.bindOperator.replace(arrayOpUnion, store, 'bigArray');
    arrayOpUnion.postMessage(workerPkg);
  };

  var updateArrayUnique = function updateArrayUnique(_ref6) {
    var bigArray = _ref6.bigArray;
    uniops.bindOperator.replace(arrayOpUnique, store, 'bigArray');
    arrayOpUnique.postMessage(bigArray);
  };

  var updateArrayIntersection = function updateArrayIntersection(_ref7) {
    var bigArray = _ref7.bigArray;
    var workerPkg = [bigArray, genBigArray(arrayOrder, arrayMaxValA)];
    uniops.bindOperator.replace(arrayOpIntersection, store, 'bigArray');
    arrayOpIntersection.postMessage(workerPkg);
  };

  var updateArrayDifference = function updateArrayDifference(_ref8) {
    var bigArray = _ref8.bigArray;
    var workerPkg = [bigArray, genBigArray(arrayOrder, arrayMaxValA)];
    uniops.bindOperator.replace(arrayOpDifference, store, 'bigArray');
    arrayOpDifference.postMessage(workerPkg);
  };

  var updateArrayObject = function updateArrayObject(_ref9) {
    var bigArray = _ref9.bigArray;
    var workerPkg = [bigArray, genBigArray(arrayOrder, arrayMaxValA)];
  ...
  return {
    loadArray: loadArray,
    updateArrayMap: updateArrayMap,
    updateArrayFilter: updateArrayFilter,
    updateArrayReduce: updateArrayReduce,
    updateArrayUnion: updateArrayUnion,
    updateArrayUnique: updateArrayUnique,
    updateArrayIntersection: updateArrayIntersection,
    updateArrayDifference: updateArrayDifference,
...
var BigArray = (0, _preact2.connect)(['bigArray'], actions)(function (_ref10) {
  var bigArray = _ref10.bigArray,
      loadArray = _ref10.loadArray,
      updateArrayMap = _ref10.updateArrayMap,
      updateArrayFilter = _ref10.updateArrayFilter,
      updateArrayReduce = _ref10.updateArrayReduce,
      updateArrayUnion = _ref10.updateArrayUnion,
      updateArrayUnique = _ref10.updateArrayUnique,
      updateArrayIntersection = _ref10.updateArrayIntersection,
      updateArrayDifference = _ref10.updateArrayDifference,
      updateArrayObject = _ref10.updateArrayObject;
  return (0, _preact.h)("ul", {
    class: "wrapper"
  }, (0, _preact.h)("li", null, (0, _preact.h)("span", null, "Offload large array Map, Filter, & Reduce operations to a background thread | "), (0, _preact.h)("span", {
    class: "btn-cluster"
  }, (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateArrayMap(e);
    },
    type: "button",
    name: "button"
  }, "Map large array"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateArrayFilter(e);
    },
    type: "button",
    name: "button"
  }, "Filter large array"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateArrayReduce(e);
    },
    type: "button",
    name: "button"
  }, "Reduce large array"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateArrayUnion(e);
    },
    type: "button",
    name: "button"
  }, "Underscore Union"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateArrayUnique(e);
    },
    type: "button",
    name: "button"
  }, "Underscore Unique"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateArrayIntersection(e);
    },
    type: "button",
    name: "button"
  }, "Underscore Intersection"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateArrayDifference(e);
    },
    type: "button",
    name: "button"
  }, "Underscore Difference"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateArrayObject(e);
    },
    type: "button",
    name: "button"
  }, "Underscore Object")), (0, _preact.h)("ul", null, (0, _preact.h)("li", null, "Doesn't block the UI. ", (0, _preact.h)("i", {
    class: "em em-clap"
  })), (0, _preact.h)("li", null, "Faster processing. ", (0, _preact.h)("i", {
    class: "em em-boom"
  })), (0, _preact.h)("li", null, "Good performance with very large array magnitudes. ", (0, _preact.h)("i", {
    class: "em em-bookmark"
  })), (0, _preact.h)("li", null, "Agnostically accepts modular/discrete array update logic. ", (0, _preact.h)("i", {
    class: "em em-admission_tickets"
  })), (0, _preact.h)("li", null, "Embedded directly within state management. ", (0, _preact.h)("i", {
    class: "em em-triangular_flag_on_post"
  })))), (0, _preact.h)("li", null, (0, _preact.h)("p", null, (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return loadArray(e);
    },
    type: "button",
    name: "button"
  }, "Create large array"), " & Run examples to see sample data... "), (0, _preact.h)("ol", {
    id: "big-array-window",
    class: bigArray.length > 0 ? 'open' : ''
  }, (0, _preact.h)("li", {
    class: "window-header"
  }, "Array Size : : ", bigArray.length.toString().replace(dispRegex, ","), " items. Total Value : :", bigArray.length > 0 ? ' ' + bigArray.reduce(function (a, c) {
    return a + c;
  }).toString().replace(dispRegex, ",") : ' 0', " "), bigArray.length > 0 ? bigArray.map(function (item, i) {
    return (0, _preact.h)("li", null, (0, _preact.h)("span", null, "Item # ", i, " : : "), "Value : : ", item.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
  }) : '')));
});
...
var _default = function _default() {
  ...
  }, (0, _preact.h)(BigArray, null));
};

exports.default = _default;
},{"preact":"../node_modules/preact/dist/preact.mjs","unistore/preact":"../node_modules/unistore/preact.js","../data/store":"assets/scripts/data/store.js","../../../../index":"../index.js"}],"assets/scripts/components/BigObject.jsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.BigObject = exports.actions = void 0;
...
var operators = {
  objectOpREST: function objectOpREST() {
    var worker_init_msg = "console.log('|UniOps| (%) objectOpREST Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.network.xhr.get);
    return worker;
  },
  objectOpGraphQL: function objectOpGraphQL() {
    var worker_init_msg = "console.log('|UniOps| (%) objectOpGraphQL Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.network.gql.query);
    return worker;
  }
};
/* * * * * * * * * * * * * * * * * * * * *
...
var objectOpREST = operators.objectOpREST();
var objectOpGraphQL = operators.objectOpGraphQL();
/* * * * * * * * * * * * * * * * * * * * *
* Operator Variables
* * * * * * * * * * * * * * * * * * * * */

var dataRESTSrc = 'https://min-api.cryptocompare.com/data/histoday?fsym=BTC&tsym=USD&limit=2000';
var dataGraphSrc = 'https://api.graphql.jobs/';
var dataGraphQry = {
  query: "{ query: jobs{title, description} }"
};
/* * * * * * * * * * * * * * * * * * * * *
* Operator Actions
* * * * * * * * * * * * * * * * * * * * */
...
var actions = function actions(store) {
  var updateObjectREST = function updateObjectREST(_ref) {
    var bigObject = _ref.bigObject;
    uniops.bindOperator.replace(objectOpREST, store, 'bigObject');
    var cachebuster = '&_=' + new Date().getTime();
    var dataSource = dataRESTSrc + cachebuster;
    objectOpREST.postMessage(dataSource);
  };

  var updateObjectGraphQL = function updateObjectGraphQL(_ref2) {
    var bigObject = _ref2.bigObject;
    var graphPkg = [dataGraphSrc, dataGraphQry];
    uniops.bindOperator.replace(objectOpGraphQL, store, 'bigObject');
    objectOpGraphQL.postMessage(graphPkg);
  };

  return {
    updateObjectREST: updateObjectREST,
    updateObjectGraphQL: updateObjectGraphQL
  };
};
/* * * * * * * * * * * * * * * * * * * * *
* Components
...
exports.actions = actions;
var BigObject = (0, _preact2.connect)(['bigObject'], actions)(function (_ref3) {
  var bigObject = _ref3.bigObject,
      updateObjectREST = _ref3.updateObjectREST,
      updateObjectGraphQL = _ref3.updateObjectGraphQL;
  return (0, _preact.h)("ul", {
    class: "wrapper"
  }, (0, _preact.h)("li", {
    id: "rest"
  }, (0, _preact.h)("span", null, "Offload XHR Requests to a background thread | "), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateObjectREST(e);
    },
    class: "btn-4",
    type: "button",
    name: "button"
  }, "Request large remote data"), (0, _preact.h)("ul", null, (0, _preact.h)("li", null, "Low Latency. ", (0, _preact.h)("i", {
    class: "em em-dart"
  })), (0, _preact.h)("li", null, "Doesn't block the UI. ", (0, _preact.h)("i", {
    class: "em em-clap"
  })), (0, _preact.h)("li", null, "Reliably deals with extended calls/slow responses. ", (0, _preact.h)("i", {
    class: "em em-100"
  })), (0, _preact.h)("li", null, "Embedded directly within state management. ", (0, _preact.h)("i", {
    class: "em em-triangular_flag_on_post"
  })))), (0, _preact.h)("li", {
    id: "qraphql"
  }, (0, _preact.h)("span", null, "Offload GraphQL Queries & Mututaions to a background thread | "), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateObjectGraphQL(e);
    },
    type: "button",
    name: "button"
  }, "Query large remote data"), (0, _preact.h)("ul", null, (0, _preact.h)("li", null, "Low Latency. ", (0, _preact.h)("i", {
    class: "em em-dart"
  })), (0, _preact.h)("li", null, "Doesn't block the UI. ", (0, _preact.h)("i", {
    class: "em em-clap"
  })), (0, _preact.h)("li", null, "Faster runtime fulfillment. ", (0, _preact.h)("i", {
    class: "em em-boom"
  })), (0, _preact.h)("li", null, "Reliably deals with extended calls/slow responses. ", (0, _preact.h)("i", {
    class: "em em-100"
  })), (0, _preact.h)("li", null, "Embedded directly within state management. ", (0, _preact.h)("i", {
    class: "em em-triangular_flag_on_post"
  })))), (0, _preact.h)("li", null, (0, _preact.h)("p", null, "Run examples to see sample data..."), (0, _preact.h)("ol", {
    id: "big-object-window",
    class: Object.keys(bigObject).length > 0 ? 'open' : ''
  }, Object.keys(bigObject).length > 0 ? bigObject.Data != undefined ? bigObject.Data.map(function (item, i) {
    return (0, _preact.h)("li", null, JSON.stringify(item));
  }) : bigObject.data.query.map(function (item, i) {
    return (0, _preact.h)("li", null, JSON.stringify(item));
  }) : '')));
});
...
var _default = function _default() {
  return (0, _preact.h)(_preact2.Provider, {
    store: _store.default
  }, (0, _preact.h)(BigObject, null));
};

exports.default = _default;
},{"preact":"../node_modules/preact/dist/preact.mjs","unistore/preact":"../node_modules/unistore/preact.js","../data/store":"assets/scripts/data/store.js","../../../../index":"../index.js"}],"assets/scripts/components/BigFile.jsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.BigFile = exports.actions = void 0;
...
var operators = {
  fileOpUpload: function fileOpUpload() {
    var worker_init_msg = "console.log('|UniOps| (%) fileOpUpload Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.file.upload);
    return worker;
  },
  fileOpBlob: function fileOpBlob() {
    var worker_init_msg = "console.log('|UniOps| (%) fileOpBlob Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.file.toblob);
    return worker;
  }
};
/* * * * * * * * * * * * * * * * * * * * *
...
var fileOpUpload = operators.fileOpUpload();
var fileOpBlob = operators.fileOpBlob();
/* * * * * * * * * * * * * * * * * * * * *
* Operator Actions
* * * * * * * * * * * * * * * * * * * * */

var actions = function actions(store) {
  var uploadFile = function uploadFile(_ref, event) {
    var BigFile = _ref.BigFile;
    var input = event.target;
    var workerPkg = input.files[0];
  ...
  var toBlob = function toBlob(_ref2) {
    var BigFile = _ref2.BigFile;
    var workerPkg = BigFile;
  ...
  var toIndexDB = function toIndexDB(_ref3) {
    var BigFile = _ref3.BigFile;
  };
...
exports.actions = actions;
var BigFile = (0, _preact2.connect)(['bigString'], actions)(function (_ref4) {
  var bigFile = _ref4.bigFile,
      uploadFile = _ref4.uploadFile,
      toBlob = _ref4.toBlob;
  return (0, _preact.h)("ul", {
    class: "wrapper"
  }, (0, _preact.h)("li", null, (0, _preact.h)("span", null, "Offload Text analysis to a background thread | "), (0, _preact.h)("button", {
    type: "button",
    name: "button"
  }, (0, _preact.h)("input", {
    id: "files",
    ...
    for: "files"
  }, "Upload file (IMG)")), (0, _preact.h)("button", {
    type: "button",
    onClick: function onClick(e) {
      return toBlob(e);
    },
    name: "button"
  }, "Transfer to Blob"), (0, _preact.h)("ul", null, (0, _preact.h)("li", null, "Doesn't block the UI. ", (0, _preact.h)("i", {
    class: "em em-clap"
  })), (0, _preact.h)("li", null, "Good performance with very large files. ", (0, _preact.h)("i", {
    class: "em em-bookmark"
  })), (0, _preact.h)("li", null, "Embedded directly within state management. ", (0, _preact.h)("i", {
    class: "em em-triangular_flag_on_post"
  })))), (0, _preact.h)("li", null, (0, _preact.h)("p", null, "Run examples to see sample data..."), (0, _preact.h)("img", {
    id: "output"
  }), (0, _preact.h)("ol", {
    id: "big-string-window",
    class: ""
  })));
});
exports.BigFile = BigFile;

var _default = function _default() {
  return (0, _preact.h)(_preact2.Provider, {
    store: _store.default
  }, (0, _preact.h)(BigFile, null));
};

exports.default = _default;
},{"preact":"../node_modules/preact/dist/preact.mjs","unistore/preact":"../node_modules/unistore/preact.js","../data/store":"assets/scripts/data/store.js","../../../../index":"../index.js"}],"assets/scripts/components/BigCanvas.jsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.BigCanvas = exports.actions = void 0;
...
var operators = {
  canvasOpInvert: function canvasOpInvert() {
    var worker_init_msg = "console.log('|UniOps| (%) canvasOpInvert Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.canvas.pixels);
    return worker;
  },
  canvasOpNoRed: function canvasOpNoRed() {
    var worker_init_msg = "console.log('|UniOps| (%) canvasOpNoRed Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.canvas.pixels);
    return worker;
  },
  canvasOpNoBlue: function canvasOpNoBlue() {
    var worker_init_msg = "console.log('|UniOps| (%) canvasOpNoBlue Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.canvas.pixels);
    return worker;
  },
  canvasOpNoGreen: function canvasOpNoGreen() {
    var worker_init_msg = "console.log('|UniOps| (%) canvasOpNoGreen Worker: Initialized');";
    var worker = uniops.buildOperator(worker_init_msg, uniops.assignOperator.canvas.pixels);
    return worker;
  }
};
...
var canvasOpInvert = operators.canvasOpInvert();
var canvasOpNoRed = operators.canvasOpNoRed();
var canvasOpNoBlue = operators.canvasOpNoBlue();
var canvasOpNoGreen = operators.canvasOpNoGreen();
/* * * * * * * * * * * * * * * * * * * * *
* Operator Variables (None)
* * * * * * * * * * * * * * * * * * * * */

var invertPixels = function invertPixels(pxls, idx) {
  pxls[idx * 4] = 255 - pxls[idx * 4];
  /* Red Channel */

  pxls[idx * 4 + 1] = 255 - pxls[idx * 4 + 1];
  /* Green Channel */

  pxls[idx * 4 + 2] = 255 - pxls[idx * 4 + 2];
  /* Blue Channel */
};

var removeRedPixels = function removeRedPixels(pxls, idx) {
  pxls[idx * 4] = 0;
  /* Red Channel */
};

var removeBluePixels = function removeBluePixels(pxls, idx) {
  pxls[idx * 4 + 1] = 0;
  /* Blue Channel */
};

var removeGreenPixels = function removeGreenPixels(pxls, idx) {
  pxls[idx * 4 + 2] = 0;
  /* Green Channel */
};
/* * * * * * * * * * * * * * * * * * * * *
...
var actions = function actions(store) {
  var loadCanvas = function loadCanvas(_ref) {
    var bigCanvas = _ref.bigCanvas;
    var cnv = document.querySelector('#big-canvas-window');
    var ctx = cnv.getContext('2d');
    var img = document.querySelector('#uniops-logo');
    ctx.imageSmoothingEnabled = false;
    ctx.drawImage(img, 0, 0);
    store.setState({
      bigCanvas: ctx.getImageData(0, 0, img.width, img.height)
    });
  };

  var downloadCanvas = function downloadCanvas(_ref2) {
    var bigCanvas = _ref2.bigCanvas;
    var cnv = document.querySelector('#big-canvas-window');
  ...
  var updateCanvasInvert = function updateCanvasInvert(_ref3) {
    var bigCanvas = _ref3.bigCanvas;
    var cnv = document.querySelector('#big-canvas-window');
    var ctx = cnv.getContext("2d");
    createImageBitmap(bigCanvas).then(function (imgBitmap) {
      ...
      var workerPkg = [invertPixels.toString(), imgData];
  ...
  var updateCanvasStripRed = function updateCanvasStripRed(_ref4) {
    var bigCanvas = _ref4.bigCanvas;
    var cnv = document.querySelector('#big-canvas-window');
    var ctx = cnv.getContext("2d");
    createImageBitmap(bigCanvas).then(function (imgBitmap) {
      ctx.imageSmoothingEnabled = false;
      ...
      var pixels = imgData.data;
      var numPixels = imgData.width * imgData.height;
      var workerPkg = [removeRedPixels.toString(), imgData];
  ...
  var updateCanvasStripBlue = function updateCanvasStripBlue(_ref5) {
    var bigCanvas = _ref5.bigCanvas;
    var cnv = document.querySelector('#big-canvas-window');
    var ctx = cnv.getContext("2d");
    createImageBitmap(bigCanvas).then(function (imgBitmap) {
      ctx.imageSmoothingEnabled = false;
      ...
      var pixels = imgData.data;
      var numPixels = imgData.width * imgData.height;
      var workerPkg = [removeBluePixels.toString(), imgData];
  ...
  var updateCanvasStripGreen = function updateCanvasStripGreen(_ref6) {
    var bigCanvas = _ref6.bigCanvas;
    var cnv = document.querySelector('#big-canvas-window');
    var ctx = cnv.getContext("2d");
    createImageBitmap(bigCanvas).then(function (imgBitmap) {
      ctx.imageSmoothingEnabled = false;
      ...
      var pixels = imgData.data;
      var numPixels = imgData.width * imgData.height;
      var workerPkg = [removeGreenPixels.toString(), imgData];
  ...
  return {
    ...
    updateCanvasInvert: updateCanvasInvert,
    updateCanvasStripRed: updateCanvasStripRed,
    updateCanvasStripBlue: updateCanvasStripBlue,
    updateCanvasStripGreen: updateCanvasStripGreen
  };
};
/* * * * * * * * * * * * * * * * * * * * *
* Components
...
exports.actions = actions;
var BigCanvas = (0, _preact2.connect)(['bigCanvas'], actions)(function (_ref7) {
  var bigCanvas = _ref7.bigCanvas,
      loadCanvas = _ref7.loadCanvas,
      downloadCanvas = _ref7.downloadCanvas,
      updateCanvasInvert = _ref7.updateCanvasInvert,
      updateCanvasStripRed = _ref7.updateCanvasStripRed,
      updateCanvasStripBlue = _ref7.updateCanvasStripBlue,
      updateCanvasStripGreen = _ref7.updateCanvasStripGreen;
  return (0, _preact.h)("ul", {
    class: "wrapper"
  }, (0, _preact.h)("li", null, (0, _preact.h)("span", null, "Offload Canvas/Pixel manipulation to a background thread | "), (0, _preact.h)("span", {
    class: "btn-cluster"
  }, (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateCanvasInvert(e);
    },
    type: "button",
    name: "button"
  }, "Invert the Image"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateCanvasStripRed(e);
    },
    type: "button",
    name: "button"
  }, "Strip Red Channel"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateCanvasStripGreen(e);
    },
    type: "button",
    name: "button"
  }, "Strip Green Channel"), (0, _preact.h)("button", {
    onClick: function onClick(e) {
      return updateCanvasStripBlue(e);
    },
    type: "button",
    name: "button"
  }, "Strip Blue Channel")), (0, _preact.h)("ul", null, (0, _preact.h)("li", null, "Doesn't block the UI. ", (0, _preact.h)("i", {
    class: "em em-clap"
  })), (0, _preact.h)("li", null, "Agnostically accepts modular/discrete pixel array update logic. ", (0, _preact.h)("i", {
    class: "em em-admission_tickets"
  })), (0, _preact.h)("li", null, "Good performance with very large pixel magnitudes. ", (0, _preact.h)("i", {
    class: "em em-bookmark"
  })), (0, _preact.h)("li", null, "Embedded directly within state management. ", (0, _preact.h)("i", {
    class: "em em-triangular_flag_on_post"
  })))), (0, _preact.h)("li", null, (0, _preact.h)("p", null, (0, _preact.h)("button", {
    ...
    type: "button",
    name: "button"
  }, "Create Canvas"), ", Run examples to see sample data and,", (0, _preact.h)("a", {
    href: bigCanvas,
    class: "button",
    id: "btn-download",
    download: "uniops.png"
    ...
    onClick: function onClick(e) {
      return downloadCanvas(e);
    },
    type: "button",
    name: "button"
  }, "Download the Image"))), (0, _preact.h)("canvas", {
    id: "big-canvas-window",
    width: "442",
    height: "600",
    class: Object.keys(bigCanvas).length > 0 ? 'open' : ''
  })));
});
exports.BigCanvas = BigCanvas;

var _default = function _default() {
  return (0, _preact.h)(_preact2.Provider, {
    store: _store.default
  }, (0, _preact.h)(BigCanvas, null));
};

exports.default = _default;
},{"preact":"../node_modules/preact/dist/preact.mjs","unistore/preact":"../node_modules/unistore/preact.js","../data/store":"assets/scripts/data/store.js","../../../../index":"../index.js"}],"assets/scripts/app.js":[function(require,module,exports) {
"use strict";
...
var _bigObjectEq = _interopRequireDefault(require("./views/bigObjectEq"));

var _bigArrayEq = _interopRequireDefault(require("./views/bigArrayEq"));

var _bigCanvasEq = _interopRequireDefault(require("./views/bigCanvasEq"));

var _bigFileEq = _interopRequireDefault(require("./views/bigFileEq"));

var _BigArray = _interopRequireDefault(require("./components/BigArray"));

var _BigObject = _interopRequireDefault(require("./components/BigObject"));

var _BigFile = _interopRequireDefault(require("./components/BigFile"));

var _BigCanvas = _interopRequireDefault(require("./components/BigCanvas"));
...
/* Register Wrappers */
var bigObjectEq = document.getElementById('bigObjectEq');
var bigArrayEq = document.getElementById('bigArrayEq');
var bigCanvasEq = document.getElementById('bigCanvasEq');
var bigFileEq = document.getElementById('bigFileEq');
var bigObject = document.getElementById('bigObject');
var bigArray = document.getElementById('bigArray');
var bigCanvas = document.getElementById('bigCanvas');
var bigFile = document.getElementById('bigFile');
/* Render Components */

(0, _preact.render)((0, _preact.h)(_bigObjectEq.default, null), bigObjectEq, bigObjectEq.lastChild);
(0, _preact.render)((0, _preact.h)(_bigArrayEq.default, null), bigArrayEq, bigArrayEq.lastChild);
(0, _preact.render)((0, _preact.h)(_bigCanvasEq.default, null), bigCanvasEq, bigCanvasEq.lastChild);
(0, _preact.render)((0, _preact.h)(_bigFileEq.default, null), bigFileEq, bigFileEq.lastChild);
(0, _preact.render)((0, _preact.h)(_BigObject.default, null), bigObject, bigObject.lastChild);
(0, _preact.render)((0, _preact.h)(_BigArray.default, null), bigArray, bigArray.lastChild);
(0, _preact.render)((0, _preact.h)(_BigCanvas.default, null), bigCanvas, bigCanvas.lastChild);
(0, _preact.render)((0, _preact.h)(_BigFile.default, null), bigFile, bigFile.lastChild);
},{"preact":"../node_modules/preact/dist/preact.mjs","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","../styles/app.scss":"assets/styles/app.scss","./views/bigObjectEq":"assets/scripts/views/bigObjectEq.jsx","./views/bigArrayEq":"assets/scripts/views/bigArrayEq.jsx","./views/bigCanvasEq":"assets/scripts/views/bigCanvasEq.jsx","./views/bigFileEq":"assets/scripts/views/bigFileEq.jsx","./components/BigArray":"assets/scripts/components/BigArray.jsx","./components/BigObject":"assets/scripts/components/BigObject.jsx","./components/BigFile":"assets/scripts/components/BigFile.jsx","./components/BigCanvas":"assets/scripts/components/BigCanvas.jsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
